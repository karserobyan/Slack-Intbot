  ...
  evidence: [
    {
      ...
      title: 'Zapier setup',
      snippet: 'Enable Zapier API access...',
      sourceQuality: 'high',
      directness: 'direct',
      freshness: 'unknown',
      sensitivity: 'safe',
...
- `data/quality-shadow.jsonl`
  ...
  - Bounded or rotatable in implementation to prevent unbounded disk growth.
...
- Existing approvals still append knowledge safely.
...
- Exact bounded retention policy for `data/quality-shadow.jsonl`.
